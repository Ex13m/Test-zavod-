  ...
  persist(
    (set, get) => ({
      ...
      settings: {
        ...
        // ИИ-агент: ключи, введённые в настройках; хранятся только
        // в этом браузере (localStorage), на сервер не сохраняются.
        // Можно несколько — используются по цепочке при сбоях/лимитах.
        aiKeys: { anthropic: '', gemini: '', openrouter: '' },
        aiKey: '', // устаревшее одиночное поле — мигрирует в aiKeys
        // дистрибуция
        tgToken: '',
        tgChatId: '',
        webhookUrl: '',
