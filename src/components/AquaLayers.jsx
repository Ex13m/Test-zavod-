...
// Рыбы фона — прозрачные стикеры Higgsfield (Recraft V4.1 →
// background remover, см. ART.silhouettes): у каждого из 5 видов
// свой монолитный силуэт без фона. Ниже — встроенные векторные
// фолбэки на случай недоступности CDN и public/art: один цельный
// path на вид, сплошная заливка, прозрачны по природе.
